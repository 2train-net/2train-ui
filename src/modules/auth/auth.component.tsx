...
import { Login, Register, Profile, ForgotPassword, PreLoader, ResetPassword } from './auth.module';

import { LOGIN, REGISTER, COMPLETE_PROFILE, FORGOT_PASSWORD, RESET_PASSWORD } from 'shared/routes';
